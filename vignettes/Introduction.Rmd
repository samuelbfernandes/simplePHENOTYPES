...
```{r ST, eval = FALSE}
simulation <- create_simulated_data(
...
```{r MT PP, results = "hide", eval = FALSE}
 sim_results <- create_simulated_data(
  genotypes_object = SNP55K_maize282_maf04,
  overlap = 3,
...
# Using your own data
If files are saved by chromosome, they may be readed from file using options . For example, if your data is saved as "WGS_chrm_1.hmp.txt", ..., "WGS_chrm_10.hmp.txt", one would load it with the following code:
